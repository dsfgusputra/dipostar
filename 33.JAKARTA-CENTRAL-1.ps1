...
$branch	     = "JAKARTA-CENTRAL-1"
$hostname    = "Desktop-u3g37l8"
$source      = "\\$hostname\c$\Users\Citra.Kustiani\Desktop\BPKB -33 JAKARTA CENTRAL 1"
$dest        = "D:\BPKB\BPKB - 33 CENTRAL JAKARTA I"
